        ...
        {step === 1 && (
          <form onSubmit={handleEmailSubmit} className="space-y-4 mt-2">
            ...
            <input
              ...
              className="w-full border border-gray-300 bg-gray-100 px-3 py-2 rounded focus:outline-none focus:ring-2 focus:ring-blue-400"
              value={email}
        ...
        {step === 2 && (
          <form onSubmit={handleOtpSubmit} className="space-y-4 mt-4">
            ...
            <input
              ...
              className="w-full border border-gray-300 bg-gray-100 px-3 py-2 rounded tracking-widest text-center focus:outline-none focus:ring-2 focus:ring-blue-400"
              onKeyDown={(e) => {
